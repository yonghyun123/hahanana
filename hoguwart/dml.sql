...
insert into file_info (id, file_name, save_file_name, content_type, delete_flag, create_date, modify_date ) values ( 129,'29_th_70.png', 'img/29_th_70.png', 'image/png', 0, now(), now());
...
insert into product_image (id, product_id, type, file_id) values ( 8,3, 'et', '67');
...
insert into product_image (id, product_id, type, file_id) values ( 99,39, 'et', '158');
